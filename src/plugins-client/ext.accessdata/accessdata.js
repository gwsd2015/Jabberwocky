...
var markup = require("text!ext/accessdata/accessdata.xml");

module.exports = ext.register("ext/accessdata/accessdata", {
    name     : "Access Data Template",
    dev      : "Ajax.org",
    alone    : true,
    deps     : [],
    type     : ext.GENERAL,
    ...
    init : function(){
        ...
        this.nodes.push(
            menus.addItemByPath("Edit/Access Data Template", new apf.item({
                command : "AutoGen"
            }), 5400)
        ); 
